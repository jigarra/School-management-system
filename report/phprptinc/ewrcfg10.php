...
define("EWR_PROJECT_ID", "{a710cf2e-15c8-4ba4-a625-e0f06e7ad7f7}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "schoolbd", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'RAEnt356sHnrt3JD', TRUE); // Random key for encryption
...
define("EWR_EMAIL_WRITE_LOG", FALSE, TRUE); // Write to log file
