...
<?php include_once "admin_profilerptinfo.php" ?>
<?php
...
$admin_profile_rpt = NULL; // Initialize page object first

class cradmin_profile_rpt extends cradmin_profile {
	...
	// Page object name
	var $PageObjName = 'admin_profile_rpt';
	...
	function __construct() {
		...
		// Table object (admin_profile)
		if (!isset($GLOBALS["admin_profile"])) {
			$GLOBALS["admin_profile"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["admin_profile"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'admin_profile', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fadmin_profilerpt";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fadmin_profilerpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fadmin_profilerpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fadmin_profilerpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($admin_profile_rpt)) $admin_profile_rpt = new cradmin_profile_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$admin_profile_rpt;
...
// Create page object
var admin_profile_rpt = new ewr_Page("admin_profile_rpt");

// Page properties
admin_profile_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = admin_profile_rpt.PageID;

// Extend page with Chart_Rendering function
admin_profile_rpt.Chart_Rendering = 
...
admin_profile_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ID"><div class="admin_profile_ID"><span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ID">
<?php if ($Page->SortUrl($Page->ID) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_ID">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_ID" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ID) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fname"><div class="admin_profile_fname"><span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fname">
<?php if ($Page->SortUrl($Page->fname) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_fname">
			<span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_fname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="lname"><div class="admin_profile_lname"><span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="lname">
<?php if ($Page->SortUrl($Page->lname) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_lname">
			<span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_lname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="_email"><div class="admin_profile__email"><span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="_email">
<?php if ($Page->SortUrl($Page->_email) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile__email">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile__email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="password"><div class="admin_profile_password"><span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="password">
<?php if ($Page->SortUrl($Page->password) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_password">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_password" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->password) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="bdate"><div class="admin_profile_bdate"><span class="ewTableHeaderCaption"><?php echo $Page->bdate->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="bdate">
<?php if ($Page->SortUrl($Page->bdate) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_bdate">
			<span class="ewTableHeaderCaption"><?php echo $Page->bdate->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_bdate" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->bdate) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->bdate->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="mobileno"><div class="admin_profile_mobileno"><span class="ewTableHeaderCaption"><?php echo $Page->mobileno->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="mobileno">
<?php if ($Page->SortUrl($Page->mobileno) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_mobileno">
			<span class="ewTableHeaderCaption"><?php echo $Page->mobileno->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_mobileno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->mobileno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->mobileno->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Updatetime"><div class="admin_profile_Updatetime"><span class="ewTableHeaderCaption"><?php echo $Page->Updatetime->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="Updatetime">
<?php if ($Page->SortUrl($Page->Updatetime) == "") { ?>
		<div class="ewTableHeaderBtn admin_profile_Updatetime">
			<span class="ewTableHeaderCaption"><?php echo $Page->Updatetime->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer admin_profile_Updatetime" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->Updatetime) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->Updatetime->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_ID"<?php echo $Page->ID->ViewAttributes() ?>><?php echo $Page->ID->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->fname->Visible) { ?>
		<td data-field="fname"<?php echo $Page->fname->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_fname"<?php echo $Page->fname->ViewAttributes() ?>><?php echo $Page->fname->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->lname->Visible) { ?>
		<td data-field="lname"<?php echo $Page->lname->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_lname"<?php echo $Page->lname->ViewAttributes() ?>><?php echo $Page->lname->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->_email->Visible) { ?>
		<td data-field="_email"<?php echo $Page->_email->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile__email"<?php echo $Page->_email->ViewAttributes() ?>><?php echo $Page->_email->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->password->Visible) { ?>
		<td data-field="password"<?php echo $Page->password->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_password"<?php echo $Page->password->ViewAttributes() ?>><?php echo $Page->password->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->bdate->Visible) { ?>
		<td data-field="bdate"<?php echo $Page->bdate->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_bdate"<?php echo $Page->bdate->ViewAttributes() ?>><?php echo $Page->bdate->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->mobileno->Visible) { ?>
		<td data-field="mobileno"<?php echo $Page->mobileno->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_mobileno"<?php echo $Page->mobileno->ViewAttributes() ?>><?php echo $Page->mobileno->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->Updatetime->Visible) { ?>
		<td data-field="Updatetime"<?php echo $Page->Updatetime->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_admin_profile_Updatetime"<?php echo $Page->Updatetime->ViewAttributes() ?>><?php echo $Page->Updatetime->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "admin_profilerptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
