...
<?php include_once "teacher_loginrptinfo.php" ?>
<?php
...
$teacher_login_rpt = NULL; // Initialize page object first

class crteacher_login_rpt extends crteacher_login {
	...
	// Page object name
	var $PageObjName = 'teacher_login_rpt';
	...
	function __construct() {
		...
		// Table object (teacher_login)
		if (!isset($GLOBALS["teacher_login"])) {
			$GLOBALS["teacher_login"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["teacher_login"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'teacher_login', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fteacher_loginrpt";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_teacher_login\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_teacher_login',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fteacher_loginrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fteacher_loginrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fteacher_loginrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($teacher_login_rpt)) $teacher_login_rpt = new crteacher_login_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$teacher_login_rpt;
...
// Create page object
var teacher_login_rpt = new ewr_Page("teacher_login_rpt");

// Page properties
teacher_login_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = teacher_login_rpt.PageID;

// Extend page with Chart_Rendering function
teacher_login_rpt.Chart_Rendering = 
...
teacher_login_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ID"><div class="teacher_login_ID"><span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ID">
<?php if ($Page->SortUrl($Page->ID) == "") { ?>
		<div class="ewTableHeaderBtn teacher_login_ID">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer teacher_login_ID" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ID) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ID->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="firstname"><div class="teacher_login_firstname"><span class="ewTableHeaderCaption"><?php echo $Page->firstname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="firstname">
<?php if ($Page->SortUrl($Page->firstname) == "") { ?>
		<div class="ewTableHeaderBtn teacher_login_firstname">
			<span class="ewTableHeaderCaption"><?php echo $Page->firstname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer teacher_login_firstname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->firstname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->firstname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="lastname"><div class="teacher_login_lastname"><span class="ewTableHeaderCaption"><?php echo $Page->lastname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="lastname">
<?php if ($Page->SortUrl($Page->lastname) == "") { ?>
		<div class="ewTableHeaderBtn teacher_login_lastname">
			<span class="ewTableHeaderCaption"><?php echo $Page->lastname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer teacher_login_lastname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lastname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lastname->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="password"><div class="teacher_login_password"><span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="password">
<?php if ($Page->SortUrl($Page->password) == "") { ?>
		<div class="ewTableHeaderBtn teacher_login_password">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer teacher_login_password" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->password) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="datetime"><div class="teacher_login_datetime"><span class="ewTableHeaderCaption"><?php echo $Page->datetime->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="datetime">
<?php if ($Page->SortUrl($Page->datetime) == "") { ?>
		<div class="ewTableHeaderBtn teacher_login_datetime">
			<span class="ewTableHeaderCaption"><?php echo $Page->datetime->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer teacher_login_datetime" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->datetime) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->datetime->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_teacher_login_ID"<?php echo $Page->ID->ViewAttributes() ?>><?php echo $Page->ID->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->firstname->Visible) { ?>
		<td data-field="firstname"<?php echo $Page->firstname->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_teacher_login_firstname"<?php echo $Page->firstname->ViewAttributes() ?>><?php echo $Page->firstname->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->lastname->Visible) { ?>
		<td data-field="lastname"<?php echo $Page->lastname->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_teacher_login_lastname"<?php echo $Page->lastname->ViewAttributes() ?>><?php echo $Page->lastname->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->password->Visible) { ?>
		<td data-field="password"<?php echo $Page->password->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_teacher_login_password"<?php echo $Page->password->ViewAttributes() ?>><?php echo $Page->password->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->datetime->Visible) { ?>
		<td data-field="datetime"<?php echo $Page->datetime->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->RecCount ?>_<?php echo $Page->RecCount ?>_teacher_login_datetime"<?php echo $Page->datetime->ViewAttributes() ?>><?php echo $Page->datetime->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "teacher_loginrptpager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
